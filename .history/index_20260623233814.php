    ...
    <div class="container hero text-center">
        <div class="row justify-content-center mb-4">
            <div class="col-12 col-md-8">
                ...
                <p class="lead ">Fast laps, live events, and friendly competition — public leaderboard and simulator.</p>
            </div>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-12 col-sm-8 col-md-4">
                <div class="card card-cta p-4 text-start h-100">
                    <h3>Leaderboard</h3>
                    <p class="">See the best laps across events and sessions — public view.</p>
