...
<head>
    ...
    <style>
        body{ min-height:100vh; background-image: url('/assets/img/raceTrack1.svg'); background-size:cover; background-position:center; }
        ...
        .card-cta { background: rgba(10,10,10,0.6); border:1px solid rgba(255,255,255,0.06); }
