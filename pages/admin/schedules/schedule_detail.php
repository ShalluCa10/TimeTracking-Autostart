...
$stmt = $conn->prepare('
    ...
    FROM sessions WHERE schedule_id = ? ORDER BY created_at DESC
');
$stmt->bind_param('i', $eventId);
$stmt->execute();
...
<div class="page-header">
    ...
    <div class="event-actions">
        <a href="../sessions/session_form.php?event_id=<?= $eventId ?>" class="btn btn--primary">+ Add Session</a>
        ...
        <tbody>
            ...
            foreach ($sessions as $session): ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="../sessions/session_form.php?id=<?= $session['session_id'] ?>&event_id=<?= $eventId ?>"
                            class="btn btn--outline">Edit</a>
                        <form method="POST" action="../sessions/session_delete.php" style="display:inline">
